...
public class ProductDeployment implements Serializable {
  ...
  @ManyToOne
  @JsonIgnoreProperties(value = { "product", "cloudEnvironment" }, allowSetters = true)
  private DepartmentProduct departmentProduct;
  ...
  public ProductDeployment environmentName(String environmentName) {
  ...
  public DepartmentProduct getDepartmentProduct() {
    return this.departmentProduct;
  }

  public void setDepartmentProduct(DepartmentProduct departmentProduct) {
    this.departmentProduct = departmentProduct;
  }

  public ProductDeployment departmentProduct(DepartmentProduct departmentProduct) {
    this.setDepartmentProduct(departmentProduct);
    return this;
  }
